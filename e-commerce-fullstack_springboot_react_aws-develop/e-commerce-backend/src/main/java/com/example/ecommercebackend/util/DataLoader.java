...
public class DataLoader {
    ...
    public CommandLineRunner initData(
        ...
        return args -> {
            ...
            if (!userRepository.existsByUserName("Samudhyatha")) {
                User seller1 = new User("Samudhyatha", "seller1@example.com", passwordEncoder.encode("password2"));
                userRepository.save(seller1);
            }

            if (!userRepository.existsByUserName("Maddikera")) {
                User admin = new User("Maddikera", "admin@example.com", passwordEncoder.encode("adminPass"));
            ...
            userRepository.findByUserName("Samudhyatha").ifPresent(seller -> {
                seller.setRoles(sellerRoles);
                userRepository.save(seller);
            });

            userRepository.findByUserName("Maddikera").ifPresent(admin -> {
